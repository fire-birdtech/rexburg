...
export function HousingCard({ housing }: HousingCardProps) {
  return (
    <Link
      ...
      className="duration-250 flex scale-100 rounded-lg bg-slate-800/50 bg-gradient-to-bl from-slate-700/50 via-transparent p-6 ring-1 ring-inset ring-white/5 transition-all focus:outline focus:outline-2 focus:outline-sky-500 motion-safe:hover:scale-[1.01]"
    >
      <img
