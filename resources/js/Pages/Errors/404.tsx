...
export default function Error404({ auth }: PageProps) {
  return (
            ...
            <div className="py-16">
              <div className="text-center">
                ...
                <p className="mt-2 text-base text-slate-500">
                  Sorry, we counldn&apos;t find the page you&apos;re looking for.
                </p>
                <div className="mt-6 flex flex-col space-y-4">
                  <Link href={route('housing.single')} className="text-base font-medium text-sky-600 hover:text-sky-700">
                    Go to single housing listings <span aria-hidden="true"> &rarr;</span>
                  </Link>
                  <Link href={route('housing.married')} className="text-base font-medium text-sky-600 hover:text-sky-700">
