                            ...
                            <div class="shadow sm:rounded-md sm:overflow-hidden">
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-sky-500 focus:border-sky-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="you@example.com" />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex items-center">
                                            ...
                                            <button type="button" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
                                                Change
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" v-model="currentHousing.phone_number" name="phone-number" id="phone-number" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                        </div>
                                                    ...
                                                    <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
                                                        <ListboxOptions class="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                                                            <ListboxOption as="template" v-for="(type, typeIdx) in housingTypes" :key="typeIdx" :value="type" v-slot="{ active, selected }">
                                                                <li :class="[active ? 'text-white bg-sky-600' : 'text-gray-900', 'cursor-default select-none relative py-2 pl-3 pr-9']">
                                        ...
                                        <div v-if="currentHousing.housing_type === 'single'" class="col-span-6 sm:col-span-4">
                                            <div class="flex items-start">
                                                <div class="flex items-center h-5">
                                                    <input id="byui-approved" name="byui-approved" type="checkbox" class="focus:ring-sky-500 h-4 w-4 text-sky-600 border-gray-300 rounded" />
                                                </div>
                                        ...
                                        <template v-for="amenity in amenities" :key="amenity.id">
                                            <div class="col-span-6 sm:col-span-2">
                                                <label class="flex items-start">
                                                    <div class="flex items-center h-5">
                                                        <input type="checkbox" :checked="selectedAmenity(amenity.name)" class="focus:ring-sky-500 h-4 w-4 text-sky-600 border-gray-300 rounded" />
                                                    </div>
                                                    <div class="ml-3 text-sm">
...
<script>
    ...
    export default {
        ...
        setup() {
            const selected = ref(housingTypes[0]);
