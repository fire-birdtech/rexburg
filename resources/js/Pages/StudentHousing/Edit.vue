<template>
    <app-layout :title="`Edit ${housing.name}`" :canLogin="canLogin" :canRegister="canRegister">
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-800 divide-y divide-slate-600 overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:px-6">
                    <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                        <div class="ml-4 mt-2">
                            <h3 class="text-2xl leading-6 font-medium text-slate-200">Edit Housing</h3>
                        </div>
                                        ...
                                        <div class="px-4 py-1 sm:px-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6 sm:col-span-4">
                                                    ...
                                                    <input type="text" v-model="currentHousing.name" name="housing-name" id="housing-name" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>
                                                ...
                                                <div class="col-span-6 sm:col-span-4">
                                                    ...
                                                    <div class="mt-1 flex rounded-md shadow-sm">
                                                        <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-slate-700 bg-slate-900 text-slate-300 text-sm">
                                                            https://
                                                        </span>
                                                        <input type="text" name="housing-website" id="housing-website" class="focus:ring-slate-500 focus:border-slate-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-slate-700 bg-slate-900 text-slate-300" placeholder="www.example.com" v-model="currentHousing.website_url" />
                                                    </div>
                                                </div>

                                                <div class="col-span-6 sm:col-span-3">
                                                    <label for="email-address" class="block text-sm font-medium text-slate-300">Email address</label>
                                                    <input type="text" v-model="currentHousing.email_address" name="email-address" id="email-address" autocomplete="email" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <input type="text" v-model="currentHousing.phone_number" name="phone-number" id="phone-number" placeholder="(555) 555-5555" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md placeholder:text-slate-500" />
                                                ...
                                                <div class="col-span-6 sm:col-span-4">
                                                    ...
                                                    <input type="text" v-model="currentHousing.street" name="street-address" id="street-address" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>

                                                <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                                    <label for="city" class="block text-sm font-medium text-slate-300">City</label>
                                                    <input type="text" v-model="currentHousing.city" name="city" id="city" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>

                                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="postal-code" class="block text-sm font-medium text-slate-300">ZIP / Postal</label>
                                                    <input type="text" v-model="currentHousing.postal_code" name="postal-code" id="postal-code" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>

                                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="rent" class="block text-sm font-medium text-slate-300">Rent range</label>
                                                    <input type="text" v-model="currentHousing.rent_range" name="rent" id="rent" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>

                                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="bedrooms" class="block text-sm font-medium text-slate-300">Bedroom range</label>
                                                    <input type="text" v-model="currentHousing.bedroom_range" name="bedrooms" id="bedrooms" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>

                                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                    <label for="bathrooms" class="block text-sm font-medium text-slate-300">Bathroom range</label>
                                                    <input type="text" v-model="currentHousing.bathroom_range" name="bathrooms" id="bathrooms" class="mt-1 focus:ring-slate-500 focus:border-slate-500 block w-full shadow-sm sm:text-sm border-slate-700 bg-slate-900 text-slate-300 rounded-md" />
                                                </div>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    <Listbox as="div" v-model="selected">
                                                        ...
                                                        <div class="mt-1 relative">
                                                            <ListboxButton class="relative w-full border border-slate-700 bg-slate-900 text-slate-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-slate-500 focus:border-slate-500 sm:text-sm">
                                                            ...
                                                            <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
                                                                <ListboxOptions class="absolute z-10 mt-1 w-full bg-slate-900 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                                                                    <ListboxOption as="template" v-for="(type, typeIdx) in housingTypes" :key="typeIdx" :value="type" v-slot="{ active, selected }">
                                                                        <li @click="updateHousingType(type.value)" :class="[active ? 'text-white bg-sky-600' : 'text-slate-200', 'cursor-default select-none relative py-2 pl-3 pr-9']">
                                                ...
                                                <div v-if="currentHousing.housing_type === 'single'" class="col-span-6 sm:col-span-4">
                                                    <div class="flex items-start">
                                                        <div class="flex items-center h-5">
                                                            <input id="byui-approved" v-model="currentHousing.byui_approved" name="byui-approved" type="checkbox" class="focus:ring-sky-500 h-4 w-4 text-slate-600 border-slate-700 rounded" />
                                                        </div>
                                                ...
                                                <template v-for="amenity in amenities" :key="amenity.id">
                                                    <div class="col-span-6 sm:col-span-2">
                                                        <label class="flex items-start" @change="updateAmenities(amenity)">
                                                            <div class="flex items-center h-5">
                                                                <input type="checkbox" :checked="findAmenity(amenity.name)" class="focus:ring-slate-500 h-4 w-4 text-slate-500 border-slate-700 rounded" />
                                                            </div>
                                                            <div class="ml-3 text-sm">
