      ...
      <div className="max-w-8xl mx-auto px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="min-w-0 flex-1">
            <h2 className="text-xl font-medium leading-7 text-slate-200 sm:truncate">
          ...
          <div className="mt-4 flex space-x-2 md:ml-4 md:mt-0">
            ...
            {claim.status === 'approved' ? (
              <span className="inline-flex items-center gap-x-1.5 rounded-full bg-green-500/10 py-1 pl-2 pr-4 text-sm font-medium text-green-400 ring-1 ring-inset ring-green-500/20">
            ...
            {claim.status === 'rejected' ? (
              <span className="inline-flex items-center gap-x-1.5 rounded-full bg-red-400/10 py-1 pl-2 pr-4 text-sm font-medium text-red-400 ring-1 ring-inset ring-red-400/20">
        ...
        <div className="mt-6 grid grid-cols-3 gap-x-4">
          <div className="col-span-2 overflow-hidden bg-slate-800 shadow sm:rounded-lg">
          ...
          <div className="col-span-1 overflow-hidden bg-slate-800 shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              <h3 className="text-lg font-medium leading-6 text-slate-200">
                User Information
              </h3>
            </div>
            <div className="space-y-8 border-t border-slate-700 px-4 py-5 sm:px-6">
              <div>
                <dt className="text-sm font-medium text-slate-400">
                  Name
                </dt>
