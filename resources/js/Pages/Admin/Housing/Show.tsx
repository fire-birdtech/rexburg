                ...
                <div className="border-t border-slate-200 px-4 py-5 dark:border-slate-700 sm:px-6">
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-1">
                      ...
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.website_url}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Email address</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.email_address}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Phone</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.phone_number}</dd>
                    </div>
                    <div className="sm:col-span-2">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Address</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{`${housing.street}, ${housing.city}, Idaho ${housing.postal_code}`}</dd>
                    </div>
                    <div className="sm:col-span-2">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">About</dt>
                      <div className="prose prose-lg mt-1 text-sm text-slate-800 dark:text-slate-200" dangerouslySetInnerHTML={{ __html: housing.about }} />
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Rent</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.rent_range}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Housing Type</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.housing_type}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Bedrooms</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.bedroom_range}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-slate-600 dark:text-slate-400">Bathrooms</dt>
                      <dd className="mt-1 text-sm text-slate-800 dark:text-slate-200">{housing.bathroom_range}</dd>
                    </div>
                  </dl>
                </div>
              </div>
