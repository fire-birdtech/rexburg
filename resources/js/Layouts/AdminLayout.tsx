...
import {
  BellIcon, HomeIcon, Squares2X2Icon, UsersIcon, XMarkIcon,
} from '@heroicons/react/24/outline';
import { Bars3Icon, ChevronDownIcon, Cog6ToothIcon } from '@heroicons/react/24/solid';
...
const navigation = [
  {
    name: 'Dashboard', href: route('admin.dashboards.main'), icon: Squares2X2Icon, components: ['Admin/Dashboards/Main'],
  },
  {
